...
ev_application_startup (GApplication *gapplication)
{
        const gchar *action_accels[] = {
          ...
          "win.redo",                   "<Ctrl>Y", "<Ctrl><Shift>Z", NULL,
          "win.delete-annotation",      "Delete", "KP_Delete", NULL,
          ...
          "win.highlight-color(int32 1)", "1", "KP_1", NULL,
          "win.highlight-color(int32 2)", "2", "KP_2", NULL,
          "win.highlight-color(int32 3)", "3", "KP_3", NULL,
          "win.highlight-color(int32 4)", "4", "KP_4", NULL,
          "win.highlight-color(int32 5)", "5", "KP_5", NULL,
          "win.highlight-color(int32 6)", "6", "KP_6", NULL,
          "win.highlight-color(int32 7)", "7", "KP_7", NULL,
          "win.highlight-color(int32 8)", "8", "KP_8", NULL,
          "win.highlight-color(int32 9)", "9", "KP_9", NULL,
          "win.highlight-color(int32 0)", "0", "KP_0", NULL,
          "win.help",                   "F1", NULL,
          "win.about",                  NULL, NULL,
          NULL
        };
